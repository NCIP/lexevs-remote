...
public class TestEnumerateRelationships extends ServiceTestCase
{
    ...
    public void testEnumerateRelationships() throws LBException
    {
        ...
        ConceptReference ref5 = ConvenienceMethods.createConceptReference("GO:0015489", GO_SCHEME);
     
        ConceptReference ref4 = ConvenienceMethods.createConceptReference("GO:0015594", GO_SCHEME);
